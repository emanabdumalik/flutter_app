...
<script type="text/template" id="siteorigin-panels-builder-row">
	<div class="so-row-container ui-draggable">
		...
		<div class="so-row-toolbar">
			...
			<span class="so-row-duplicate so-tool-button"><span class="so-panels-icon so-panels-icon-arrows-v"></span></span>
			<span class="so-row-delete so-tool-button"><span class="so-panels-icon so-panels-icon-arrows-v"></span></span>
			<span class="so-row-settings so-tool-button"><span class="so-panels-icon so-panels-icon-arrows-v"></span></span>
...
<script type="text/template" id="siteorigin-panels-builder-cell">
	<div class="cell">
		...
		<div id="crap" class="cell-wrapper widgets-container">
...
<script type="text/template" id="siteorigin-panels-builder-widget">
	<div class="so-widget ui-widget-content" >
		<div class="so-widget-wrapper" >
			<div class="title">

					<span class="actions">

												<a class="widget-move"><small class=""><div data-sow-icon="&#xf047;" data-value="fontawesome-arrows-h" class="sow-icon-fontawesome siteorigin-widget-icon-icons-icon"></div></small></a>
						<a class="widget-display"><small class=""><div data-sow-icon="&#xf06e;" data-value="fontawesome-arrows-h" class="sow-icon-fontawesome siteorigin-widget-icon-icons-icon"></div></small></a>
						<a class="widget-image"><small class=""><div data-sow-icon="&#xf1c5;" data-value="fontawesome-arrows-h" class="sow-icon-fontawesome siteorigin-widget-icon-icons-icon"></div></small></a>

						<a class="widget-float"><small class=""><div data-sow-icon="&#xf0ec;" data-value="fontawesome-arrows-h" class="sow-icon-fontawesome siteorigin-widget-icon-icons-icon"></div></small></a>
						<a class="widget-margin"><small class=""><div data-sow-icon="&#xf08b;" data-value="fontawesome-arrows-h" class="sow-icon-fontawesome siteorigin-widget-icon-icons-icon"></div></small></a>
						<a class="widget-padding"><small class=""><div data-sow-icon="&#xf090;" data-value="fontawesome-arrows-h" class="sow-icon-fontawesome siteorigin-widget-icon-icons-icon"></div></small></a>

						<a class="widget-resize"><small class=""><div data-sow-icon="&#xf07e;" data-value="fontawesome-arrows-h" class="sow-icon-fontawesome siteorigin-widget-icon-icons-icon"></div></small></a>
						<a class="widget-edit"><small class=""><div data-sow-icon="&#xf044;" data-value="fontawesome-arrows-h" class="sow-icon-fontawesome siteorigin-widget-icon-icons-icon"></div></small></a>

						<a class="widget-duplicate"><small class=""><div data-sow-icon="&#xf0c5;" data-value="fontawesome-arrows-h" class="sow-icon-fontawesome siteorigin-widget-icon-icons-icon"></div></small></a>
						<a class="widget-delete"><small class=""><div data-sow-icon="&#xf00d;" data-value="fontawesome-arrows-h" class="sow-icon-fontawesome siteorigin-widget-icon-icons-icon"></div></small></a>
