...
function siteorigin_widget_post_selector_enqueue_admin_scripts() {
	if ( ! wp_script_is( 'siteorigin-widget-admin-posts-selector' ) ) {
		...
		wp_enqueue_style( 'siteorigin-widget-admin-posts-selector', get_template_directory_uri().'/lib/posts-selector/post-selector.css', array(), '' );
		wp_enqueue_style( 'siteorigin-widget-admin-posts-selector2', get_template_directory_uri().'/lib/posts-selector/admin.css', array(), '' );

		wp_enqueue_script( 'siteorigin-widget-admin-posts-selector', get_template_directory_uri().'/lib/posts-selector/posts-selector.js', array( 'jquery', 'jquery-ui-sortable', 'jquery-ui-autocomplete', 'underscore', 'backbone' ), false, true );
		...
		wp_localize_script( 'siteorigin-widget-admin-posts-selector', 'sowPostsSelectorTpl', array(
			...
			'modal' => file_get_contents( get_template_directory().'/lib/posts-selector/modal.html' ),
			'postSummary' => file_get_contents( get_template_directory().'/lib/posts-selector/post.html' ),
			...
			'selector' => file_get_contents( get_template_directory().'/lib/posts-selector/selector.html' ),
		) );
