...
function input_admin_enqueue_scripts() {
		$script = acf_get_url("assets/inc/flexible-content/input.js");
		$style = acf_get_url("assets/inc/flexible-content/input.css");
		
		



		wp_enqueue_script( 'acf-input-flexible-content', $script, array('acf-input'), '2.0.0' );
		wp_enqueue_style( 'acf-input-flexible-content', $style, '', '2.0.0' );
		
	}
	function field_group_admin_enqueue_scripts()
	{
		$script = acf_get_url("assets/inc/flexible-content/field-group.js");
		$style = acf_get_url("assets/inc/flexible-content/field-group.css");
		wp_register_script( 'acf-field-group-flexible-content', $script, array('acf-field-group'), $this->settings['version']);
		wp_register_style( 'acf-field-group-flexible-content', $style, array('acf-field-group'), $this->settings['version'] ); 
