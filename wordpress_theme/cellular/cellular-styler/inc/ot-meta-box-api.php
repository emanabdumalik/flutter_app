 ...
 */
if ( ! class_exists( 'OT_Css_Meta_Box' ) ) {

  class OT_Css_Meta_Box {
    ...
    function __construct( $meta_box ) {
      ...
      global $ot_css_meta_boxes;

      if ( ! isset( $ot_css_meta_boxes ) ) {
        $ot_css_meta_boxes = array();
      }

      $ot_css_meta_boxes[] = $meta_box;
        ...
        if ( isset( $_POST[$field['id']] ) ) {
          ...
          if ( $field['type'] == 'css' ) {
            ...
            if ( '' !== $new ) {
              ...
              if($post_object->post_type == 'widget')
              update_widget_css($post_object->ID,$new);
 ...
 * @since    2.0
 */
if ( ! function_exists( 'ot_css_register_meta_box' ) ) {

  function ot_css_register_meta_box( $args ) {
    if ( ! $args )
      return;
      
    $ot_css_meta_box = new OT_Css_Meta_Box( $args );
  }
