...
class TinyMCE_Custom_Class {
	...
	*/
	...
	function add_tinymce_plugin( $plugin_array ) {
	    ...
	    $plugin_array['custom_class'] = get_template_directory_uri(  ) . '/lib//tiny/js/tinymce-custom-class.js';
	    return $plugin_array;
	...
	*/
	function admin_scripts_css() {
		...
		wp_enqueue_style( 'tinymce-custom-class', get_template_directory_uri(). '/lib//tiny/css/tinymce-custom-class.css' );
