...
angular.module('naolMobi',[])
    
.controller('AppController',AppController);
function AppController($scope){
alert(my_var.plugin_url);
$scope.me='semir worku aman';
} 
})(angular);
odoo.define("app", function(require) {
  ...
  async function start() {
    // prepare QWeb
    const templates = await fetch(my_var.plugin_url+"/templates.xml");
