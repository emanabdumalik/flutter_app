...
//stylebot.chrome.fetchOptions();
  var options = {"options":{"accordions":[0,1,2,3],"contextMenu":true,"livePreviewColorPicker":true,"livePreviewPage":true,"mode":"Basic","shortcutKey":77,"shortcutMetaKey":"alt","sync":false,"useShortcutKey":true}};
  initialize(options);
});
