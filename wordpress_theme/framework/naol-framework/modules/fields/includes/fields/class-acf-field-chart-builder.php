...
if (!class_exists('acf_field_chart_builder')):

    class acf_field_chart_builder extends acf_field
{
        ...
        public function initialize()
    {
            ...
            // vars
            $this->name     = 'chart_builder';
            $this->label    = __("Chart Builder", 'acf');
            $this->defaults = array(
                'default_value' => '',
                'maxlength'     => '',
                'placeholder'   => '',
...
// initialize
    acf_register_field_type('acf_field_chart_builder');
