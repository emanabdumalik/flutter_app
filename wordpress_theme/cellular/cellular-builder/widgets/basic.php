 ...
 */
class SiteOrigin_Panels_Front_Widgets_Layout extends WP_Widget {
	function __construct() {
		parent::__construct(
			'siteorigin-panels-builder-front',
			// TRANSLATORS: This is the name of a widget
			__( 'Front Layout Builder', 'siteorigin-panels' ),
			array(
	...
	function form($instance){
		...
		if( ! is_string( $instance['panels_data'] ) ) {
			...
			include 'front-end-builder-template.php';
...
function siteorigin_panels_basic_widgets_init(){
	...
	register_widget('SiteOrigin_Panels_Front_Widgets_Layout');
